...
# coding=utf-8
# --------------------------------------------------------------------------
# Code generated by Microsoft (R) AutoRest Code Generator (autorest: 3.10.8, generator: @autorest/python@6.41.4)
...
class KnowledgeSourceParams(_serialization.Model):
    ...
    :vartype kind: str or ~azure.search.documents.knowledgebase.models.KnowledgeSourceKind
    """
...
class ErrorDetail(_serialization.Model):
    ...
    :vartype details: list[~azure.search.documents.knowledgebase.models.ErrorDetail]
    :ivar additional_info: The error additional info.
    :vartype additional_info:
     list[~azure.search.documents.knowledgebase.models.ErrorAdditionalInfo]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.search.documents.knowledgebase.models.ErrorDetail
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetail"] = None, **kwargs: Any) -> None:
        ...
        :paramtype error: ~azure.search.documents.knowledgebase.models.ErrorDetail
        """
        super().__init__(**kwargs)
        self.error = error
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :keyword error: The error detail explaining why the operation failed. This property is only
         included when the activity does not succeed.
        :paramtype error: ~azure.search.documents.knowledgebase.models.KnowledgeBaseErrorDetail
        """
        super().__init__(**kwargs)
        self.id = id
        self.type: Optional[str] = None
...
class KnowledgeBaseAzureBlobActivityRecord(KnowledgeBaseRetrievalActivityRecord):
    ...
    :vartype azure_blob_arguments:
     ~azure.search.documents.knowledgebase.models.KnowledgeBaseAzureBlobActivityArguments
    """
...
class KnowledgeBaseIndexedOneLakeActivityRecord(KnowledgeBaseRetrievalActivityRecord):  # pylint: disable=name-too-long
    ...
    :vartype indexed_one_lake_arguments:
     ~azure.search.documents.knowledgebase.models.KnowledgeBaseIndexedOneLakeActivityArguments
    """
...
class KnowledgeBaseIndexedSharePointActivityRecord(
    ...
    :vartype indexed_share_point_arguments:
     ~azure.search.documents.knowledgebase.models.KnowledgeBaseIndexedSharePointActivityArguments
    """
...
class KnowledgeBaseMessageImageContent(KnowledgeBaseMessageContent):
    ...
    :ivar image: Required.
    :vartype image:
     ~azure.search.documents.knowledgebase.models.KnowledgeBaseMessageImageContentImage
    """
...
class KnowledgeBaseRemoteSharePointActivityRecord(
    ...
    :vartype remote_share_point_arguments:
     ~azure.search.documents.knowledgebase.models.KnowledgeBaseRemoteSharePointActivityArguments
    """
...
class KnowledgeBaseRetrievalRequest(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        :paramtype messages: list[~azure.search.documents.knowledgebase.models.KnowledgeBaseMessage]
        :keyword intents: A list of intended queries to execute without model query planning.
        :paramtype intents: list[~azure.search.documents.knowledgebase.models.KnowledgeRetrievalIntent]
...
class KnowledgeBaseRetrievalResponse(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        """
        :keyword response:
        :paramtype response: list[~azure.search.documents.knowledgebase.models.KnowledgeBaseMessage]
        ...
        :paramtype references:
         list[~azure.search.documents.knowledgebase.models.KnowledgeBaseReference]
        """
        super().__init__(**kwargs)
...
class KnowledgeBaseSearchIndexActivityArguments(_serialization.Model):  # pylint: disable=name-too-long
    ...
    :vartype source_data_fields:
     list[~azure.search.documents.knowledgebase.models.SearchIndexFieldReference]
...
class KnowledgeBaseSearchIndexActivityRecord(KnowledgeBaseRetrievalActivityRecord):
    ...
    :vartype search_index_arguments:
     ~azure.search.documents.knowledgebase.models.KnowledgeBaseSearchIndexActivityArguments
    """
...
class KnowledgeBaseWebActivityRecord(KnowledgeBaseRetrievalActivityRecord):
    ...
    :vartype web_arguments:
     ~azure.search.documents.knowledgebase.models.KnowledgeBaseWebActivityArguments
    """
