...
class TestKnowledgeBaseConfigurationLiveAsync(AzureRecordedTestCase):
    ...
    async def test_knowledge_base_configuration_round_trip(self, endpoint: str) -> None:
        ...
        try:
            ...
            assert isinstance(created.retrieval_reasoning_effort, KnowledgeRetrievalMinimalReasoningEffort)
            ...
            assert isinstance(fetched.retrieval_reasoning_effort, KnowledgeRetrievalMinimalReasoningEffort)
