...
index_name = "workflow-sample-index"
data_source_name = "workflow-sample-blob"
skillset_name = "workflow-sample-skillset"
indexer_name = "workflow-sample-indexer"
...
def sample_indexer_workflow():
    ...
    print(f"Indexer scheduled: {updated_indexer.schedule.interval}")
