...
semantic_configuration_name = "sample-semantic-config"
...
def create_semantic_configuration():
    ...
    print(f"Updated index {index_name} with semantic configuration '{semantic_configuration_name}'")
...
def delete_semantic_configuration():
    ...
    index_client.create_or_update_index(index)
    print(f"Cleaned up semantic configuration from index {index_name}")
