...
data_source_connection_name = "sample-blob-datasource-connection"
...
def create_data_source_connection():
    ...
    data_source_connection = SearchIndexerDataSourceConnection(
        name=data_source_connection_name, type="azureblob", connection_string=connection_string, container=container
    )
...
def delete_data_source_connection():
    ...
    print(f"Data Source Connection '{data_source_connection_name}' successfully deleted")
