...
"""
DESCRIPTION:
    Demonstrates how to analyze text using a specific analyzer (standard.lucene) on a search index.
...
async def simple_analyze_text():
    ...
    async with search_index_client:
        analysis_result = await search_index_client.analyze_text(index_name, analyze_request)
