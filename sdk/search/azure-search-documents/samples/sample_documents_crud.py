...
def upload_document():
    ...
    document = {
        ...
        "Category": "Luxury",
        "Tags": ["pool", "view", "wifi", "concierge", "private beach", "gourmet dining", "spa"],
...
def merge_document():
    ...
    result = search_client.merge_documents(documents=[{"HotelId": "1000", "HotelName": "Azure Sanctuary & Spa"}])
...
def get_document():
    ...
    result = search_client.get_document(key="1000")
